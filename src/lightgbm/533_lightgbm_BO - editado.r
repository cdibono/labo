...
hs <- makeParamSet( 
  ...
  makeIntegerParam("num_leaves",       lower= 16L   , upper= 300L),
...
ksemilla_azar  <- 192571  #Aqui poner la propia semilla
...
EstimarGanancia_lightgbm  <- function( x )
{
  ...
  param_basicos  <- list( objective= "binary",
                          ...
                          #lambda_l1= 0.0,         #se comenta como en script 537
                          #lambda_l2= 0.0,         #se comenta como en script 537
                          max_bin= 31,            #por ahora, lo dejo fijo
                          num_iterations= 9999,    #un numero muy grande, lo limita early_stopping_rounds
                          force_row_wise= TRUE,    #para que los alumnos no se atemoricen con tantos warning
                          scale_pos_weight = 245 # Para datasets con clases desbalanceadas. Negativas 158.740 vs positivas 648
                          )
...
setwd("C:\\Users\\cdibono\\OneDrive - TERNIUM\\Austral\\Materias\\11. Laboratorios de implementación\\labo\\exp\\HT5330\\")   #Establezco el Working Directory DEL EXPERIMENTO
