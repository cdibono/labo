...
AgregarVariables  <- function( dataset )
{
  ...
  ### Disclaimer a partir de ac· es un HURTO literal a los compaÒeros DRAGO y LARRETA 
  ### que muy amablemente compartieron su cÛdigo en GITHUB, los invito a HURTAR con toda libertad
  ### mi cÛdigo.
  ...
  ### Disclaimer a partir de ac· es un HURTO literal al compaÒero MFER https://github.com/mjferh 
  ### que muy amablemente compartiÛ su cÛdigo en GITHUB, los invito a HURTAR con toda libertad
  ### mi cÛdigo.  
  ...
  ### Disclaimer a partir de ac· es un HURTO literal a los compaÒeros Molfino-Mac 
  ### que muy amablemente compartieron su cÛdigo en GITHUB, los invito a HURTAR con toda libertad
  ### mi cÛdigo.   
  
  dataset[ , varnueva_MM_1 := mcuenta_corriente + mcuenta_corriente_adicional]
  dataset[ , varnueva_MM_2 := mcaja_ahorro + mcaja_ahorro_adicional + mcaja_ahorro_dolares]
  dataset[ , varnueva_MM_3 := montos_ctacorr / ccuenta_corriente]
  dataset[ , varnueva_MM_4 := montos_cajaho / ccaja_ahorro]
  dataset[ , varnueva_MM_5 := montos_ctacorr / montos_cajaho]
  dataset[ , varnueva_MM_6 := (mautoservicio + mtarjeta_visa_consumo + mtarjeta_master_consumo) / (ctarjeta_debito_trx + ctarjeta_visa_trx + ctarjeta_master_trx)]
  dataset[ , varnueva_MM_7 := (mautoservicio + mtarjeta_visa_consumo + mtarjeta_master_consumo) / (ctarjeta_debito + ctarjeta_visa + ctarjeta_master)]
  dataset[ , varnueva_MM_8 := (ctarjeta_debito_trx+ ctarjeta_visa_trx + ctarjeta_master_trx) / (ctarjeta_debito + ctarjeta_visa + ctarjeta_master)]
  dataset[ , varnueva_MM_9 := (ctarjeta_visa_trx + ctarjeta_master_trx) / (ctarjeta_visa + ctarjeta_master)]
  dataset[ , varnueva_MM_10 := cliente_edad / cproductos]
